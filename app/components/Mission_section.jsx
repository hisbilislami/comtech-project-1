...
export default function Mission_section() {
  return (
    <div className="h-[100vh] w-full mb-20 bg-hmi-timberwolf">
      <div className="m-40 relative bg-hmi-white">
        <div className="border-8 border-black rounded-3xl p-8">
          <p
            className={`${gloriaHalelujahFont.className} uppercase font-bold text-center text-hmi-orange mt-16 mb-8}`}
          >
          ...
          <p className="text-sm text-hmi-battleship-gray text-center m-8">
            ...
            <div className="w-full">
              <div className="flex">
                ...
                <div className="mx-4">
                  ...
                  <p className="mt-4 mb-20 text-hmi-battleship-gray">
